...
\section{Análisis de Telemetría y Ascenso de una Sonda Meteorológica Estratosférica }
	...
	Copien y peguen el siguiente bloque de datos en su script. 
	Toda operación debe estar vectorizada con \texttt{numpy}.
	...
	\begin{itemize}
		\item \textbf{Tarea:} Creen un nuevo vector 
		temporal $t_{reg}$ desde 0 hasta 145 segundos con 200 puntos 
		equiespaciados. 
		Utilicen interpolación lineal o polinómica 
		 para estimar la altitud $h(t_{reg})$ en estos nuevos instantes.
	\end{itemize}
	...
	\begin{enumerate}
		...
		\item \textbf{Panel Numérico (Text):} 
		Un área de la figura dedicada a mostrar el texto con las 
		respuestas numéricas del apartado activo. 
	...
	\begin{itemize}
		...
		la física detrás de los resultados 
		(impresos en consola o en la GUI) son vitales. 
		Justifiquen si los valores de velocidad o energía calculados tienen sentido en un entorno aeroespacial.
	\end{itemize}
