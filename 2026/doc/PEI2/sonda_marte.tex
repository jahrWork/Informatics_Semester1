\section{Análisis Telemétrico y Aerodinámico del Lanzamiento de una Sonda a Marte}
	...
	\end{cases}
	\]
	\textbf{Tarea:} Resuelve el sistema utilizando 
	el módulo de álgebra lineal para encontrar la masa en cada tanque.
	...
	\textbf{Tarea:} Utiliza un algoritmo de interpolación 
	lineal en 1D  para construir un nuevo array con la densidad atmosférica $\rho(t)$ correspondiente a cada instante temporal del vuelo.
