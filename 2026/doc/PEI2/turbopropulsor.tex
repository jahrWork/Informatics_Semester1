...
\section{Análisis Numérico y Telemetría del Rendimiento de un Turbopropulsor}
	...
	se exige abandonar las figuras estáticas aisladas. 
	Se deberá programar una única ventana gráfica utilizando \texttt{matplotlib} (y su módulo \texttt{matplotlib.widgets}) con los siguientes elementos:
	...
	\begin{itemize}
		...
		\item \textbf{Estructura:} Cada apartado numérico debe estar 
		encapsulado en una función \\
		(ej. \texttt{def resolver\_mach\_critico(h\_array):}).
		\item \textbf{Interpretación:} En el código, 
		agregue comentarios breves que expliquen si el orden de magnitud del resultado obtenido tiene sentido físico en el contexto aeronáutico.
	\end{itemize}
